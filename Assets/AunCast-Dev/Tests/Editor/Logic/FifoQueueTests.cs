...
namespace PasocomMate.AunCast.Tests
{
    public class FifoQueueTests
    {
        ...
        public void SelectNextQueuedUser_ReturnsOldestTimestamp()
        {
            ...
            resyncState[2] = (byte)AunCastResyncCoordinator.STATE_QUEUED;
            timestamps[2] = 10f;
            resyncState[5] = (byte)AunCastResyncCoordinator.STATE_QUEUED;
            timestamps[5] = 5f;
            resyncState[8] = (byte)AunCastResyncCoordinator.STATE_QUEUED;
            timestamps[8] = 15f;
        ...
        public void CountGrantedOrRunning_MixedStates()
        {
            ...
            resyncState[1] = (byte)AunCastResyncCoordinator.STATE_RUNNING;
            resyncState[2] = (byte)AunCastResyncCoordinator.STATE_QUEUED;
            resyncState[3] = (byte)AunCastResyncCoordinator.STATE_RUNNING;
            resyncState[4] = (byte)AunCastResyncCoordinator.STATE_NONE;
