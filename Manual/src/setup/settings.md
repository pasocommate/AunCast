...
- **既存プレイヤー出力の変換** … 既存の AVPro スクリーン / スピーカーを AunCast 用の出力宣言へ変換
- **旧プレイヤー本体の手動削除候補** … 変換候補では扱わない旧 `VRCAVProVideoPlayer` 本体
- **出力・参照の再配線** … 中核参照とシーン内のスクリーン / スピーカー / 互換トンネルを再配線するボタン
