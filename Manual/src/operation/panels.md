...
!!! info "スタッフ用の入口もここにあります"
    右下の鍵アイコンから、スタッフ用の暗証番号を入力する画面に切り替えられます。詳細は[スタッフビューを解錠する](panel-staff.md#unlock)を参照してください。鍵アイコンは壁パネルごとに非表示にすることもできます（[壁パネルごとに鍵アイコンを隠せます](panel-staff.md#unlock)）。
