...
テストコード: `Assets/AunCast-Dev/Tests/Editor/`

### Setup 系

| テスト | 検証内容 |
|--------|---------|
| `AllUdonSharpScripts_HaveMatchingAsset` | 全 UdonSharp .cs に対応する .asset が存在する |
...
| E2 | 一般ユーザーが後から参加 | 再生中 URL を自動受信して再生開始、driftWarmup 中 Resync なし | | |
